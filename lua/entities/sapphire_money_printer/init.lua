...
ENT.SeizeReward = gemstone.config.sapphireSeizeReward
...
function ENT:Initialize()
	...
	self.damage = gemstone.config.sapphireHealth
...
function ENT:OnTakeDamage(dmg)
	...
	self.damage = (self.damage or gemstone.config.sapphireHealth) - dmg:GetDamage()
