...
ENT.SeizeReward = gemstone.config.rubySeizeReward
...
function ENT:Initialize()
	...
	self.damage = gemstone.config.rubyHealth
...
function ENT:OnTakeDamage(dmg)
	...
	self.damage = (self.damage or gemstone.config.rubyHealth) - dmg:GetDamage()
