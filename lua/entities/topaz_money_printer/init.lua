...
ENT.SeizeReward = gemstone.config.topazSeizeReward
...
function ENT:Initialize()
	...
	self.damage = gemstone.config.topazHealth
...
function ENT:OnTakeDamage(dmg)
	...
	self.damage = (self.damage or gemstone.config.topazHealth) - dmg:GetDamage()
