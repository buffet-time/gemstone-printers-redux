...
ENT.SeizeReward = gemstone.config.amethystSeizeReward
...
function ENT:Initialize()
	...
	self.damage = gemstone.config.amethystHealth
...
function ENT:OnTakeDamage(dmg)
	...
	self.damage = (self.damage or gemstone.config.amethystHealth) - dmg:GetDamage()
...
function ENT:CreateMoneybag()
	...
	if math.random(1, gemstone.config.catchFireChance) == 1 and gemstone.config.catchFire == true then self:BurstIntoFlames() end
